...
export const CHAMPIONS: ChampionDef[] = [
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 32, mrPerLvl: 1.5,
      moveSpeed: 90, attackSpeed: 0.90, asPerLvl: 0.02, attackRange: 20,
    },
    preferredLane: "top",
  ...
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 30, mrPerLvl: 1.3,
      moveSpeed: 87, attackSpeed: 0.88, asPerLvl: 0.018, attackRange: 88,
    },
    preferredLane: "mid",
  ...
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 28, mrPerLvl: 1.2,
      moveSpeed: 88, attackSpeed: 0.98, asPerLvl: 0.032, attackRange: 90,
    },
    preferredLane: "bot",
  ...
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 30, mrPerLvl: 1.3,
      moveSpeed: 94, attackSpeed: 0.95, asPerLvl: 0.028, attackRange: 21,
    },
    preferredLane: "mid",
  ...
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 32, mrPerLvl: 1.4,
      moveSpeed: 88, attackSpeed: 0.87, asPerLvl: 0.017, attackRange: 86,
    },
    preferredLane: "bot",
  ...
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 30, mrPerLvl: 1.4,
      moveSpeed: 92, attackSpeed: 0.92, asPerLvl: 0.027, attackRange: 19,
    },
    preferredLane: "top",
  ...
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 34, mrPerLvl: 1.6,
      moveSpeed: 89, attackSpeed: 0.88, asPerLvl: 0.02, attackRange: 21,
    },
    preferredLane: "bot",
  ...
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 30, mrPerLvl: 1.3,
      moveSpeed: 86, attackSpeed: 0.87, asPerLvl: 0.017, attackRange: 87,
    },
    preferredLane: "mid",
