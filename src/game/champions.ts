...
export const CHAMPIONS: ChampionDef[] = [
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 32, mrPerLvl: 1.5,
      moveSpeed: 90, attackSpeed: 0.64, asPerLvl: 0.02, attackRange: 58,
    },
    preferredLane: "top",
  ...
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 30, mrPerLvl: 1.3,
      moveSpeed: 87, attackSpeed: 0.63, asPerLvl: 0.018, attackRange: 152,
    },
    preferredLane: "mid",
  ...
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 28, mrPerLvl: 1.2,
      moveSpeed: 88, attackSpeed: 0.7, asPerLvl: 0.032, attackRange: 158,
    },
    preferredLane: "bot",
  ...
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 30, mrPerLvl: 1.3,
      moveSpeed: 94, attackSpeed: 0.68, asPerLvl: 0.028, attackRange: 60,
    },
    preferredLane: "mid",
  ...
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 32, mrPerLvl: 1.4,
      moveSpeed: 88, attackSpeed: 0.62, asPerLvl: 0.017, attackRange: 148,
    },
    preferredLane: "bot",
  ...
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 30, mrPerLvl: 1.4,
      moveSpeed: 92, attackSpeed: 0.66, asPerLvl: 0.027, attackRange: 56,
    },
    preferredLane: "top",
  ...
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 34, mrPerLvl: 1.6,
      moveSpeed: 89, attackSpeed: 0.63, asPerLvl: 0.02, attackRange: 62,
    },
    preferredLane: "bot",
  ...
  // =========================================================================
  {
    ...
    base: {
      ...
      mr: 30, mrPerLvl: 1.3,
      moveSpeed: 86, attackSpeed: 0.62, asPerLvl: 0.017, attackRange: 150,
    },
    preferredLane: "mid",
